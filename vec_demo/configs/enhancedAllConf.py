...
# 修改数据集相关配置
data_root = 'data/ard/enhancedall/'
...
val_evaluator = dict(
    ...
    outfile_prefix='D:/zcp/heightStereo/work_dirs/enhancedAllConf/results/',  # 保存结果文件的路径
